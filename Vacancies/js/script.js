...
const accordion = document.querySelectorAll('.company-accordion')

accordion.forEach(function(e){
    e.addEventListener("click", function(){
        let myClasses = document.querySelectorAll('.company-accordion div:nth-child(2)')
        let i = 0;
        ...
        e.querySelector('.company-accordion__cross').classList.toggle("active")

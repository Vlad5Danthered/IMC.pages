...
backgroundWindow.addEventListener("click", function(){
    ...
    let l = 4;
        ...
        for (i = 0; i < l; i++) {
            windowBtns[i].classList.remove("active")
            // console.log(windowBtns[i])
        }
})
// let btnService = document.querySelector('.header-navbar__btn-service');



// function funActiveService(){
//     let windowService = document.querySelector('.header-window-service')

//     if(btnService.classList.contains("active")){
//         windowService.style.display = 'flex'
//     }
//     else{
//         windowService.style.display = 'none'
//     }
// }

// let btnCompany = document.querySelector('.header-navbar__btn-company');

// btnCompany.addEventListener("click", function(){
//     this.classList.toggle('active')
//     funActiveCompany()
//     funRemoveActiveCompanySerivce()
// })

// function funActiveCompany(){
//     let windowService = document.querySelector('.header-window-company')
...
// function funRemoveActiveCompanySerivce(){
//     let myClasses = document.querySelectorAll('.header-navbar__btn')
//     let i = 0;
//     let l = myClasses.length;
//     for (i; i < l; i++) {
//         myClasses[i].classList.remove("active")
